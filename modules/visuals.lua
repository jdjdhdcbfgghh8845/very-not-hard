...
local Module = {
    Name = "Visuals",
    Icon = "rbxassetid://6034784534"
}

function Module.Init()
    local page = _G.Nexus.Core.UI:CreatePage("Visuals", Module.Icon)
    
    local esp = page:AddFeatureTile("ESP", "rbxassetid://6034784534", false, function(state) end)
    ...
    local chams = page:AddFeatureTile("Chams", "rbxassetid://6034784558", false, function(state) end)
    chams:AddToggle("Team Check", true, function(s) end)
    
    local tracers = page:AddFeatureTile("Tracers", "rbxassetid://6034784606", false, function(state) end)
