...
function Module.Init()
    ...
    local esp = page:AddFeatureTile("ESP", "ESP", false, function(state) end)
    ...
    local chams = page:AddFeatureTile("Chams", "Visuals", false, function(state) end)
    chams:AddToggle("Team Check", true, function(s) end)
    
    local tracers = page:AddFeatureTile("Tracers", "Visuals", false, function(state) end)
